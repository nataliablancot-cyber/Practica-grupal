...
Entender y Refactorizar código existente.


Diseñar una arquitectura desacoplada y limpia.


Implementar soluciones técnicas avanzadas (bases de datos, APIs, interfaces gráficas).
...
Eliminar la dependencia del CSV: Migrar a una base de datos real usando SQLAlchemy.


Separar responsabilidades: Que la UI no hable directamente con la BD, sino a través de Servicios/API.


Dockerizar: Mantener/Mejorar el docker-compose.yml para que todo arranque con un comando.
